...
bash $BASEDIR/toolkit/l_BaseKit_p_2021.1.0.2659.sh -f $BASEDIR/toolkit/extract -s --eula accept --install-dir $BASEDIR/toolkit/install --download-dir $BASEDIR/toolkit/download
